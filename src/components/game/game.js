...
class SnakeGame {
  ...
  startGame() {
    ...
    // Reset a things from the prior game
  ...
  generateFood() {
    // If there is uneaten food on the canvas then no need to regenerate new food 
    if(this.food.active) {
  ...
  detectCollision() {
    // Self collison
    // Impossible for the first 3 pieces of the snake to self collide -> therfore loop starts: 4
